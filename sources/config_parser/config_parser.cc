...
ft::config::categoryObject				*ft::config::getCategoryObject(std::string &category)
{
...
ft::config::categoryObject				*ft::config::getCategoryObject(categoryObject *object, std::string &category)
{
	categoryObject	*objectRet;
...
std::vector<std::string>	ft::config::getCategoryInteriorFields(std::string &category)
{
...
std::vector<std::string>	ft::config::getCategoryInteriorFields(categoryObject *object, std::string &category)
{
	std::vector<std::string> 	fieldsRet;
	categoryType	location = object->subcategory;
	std::vector<std::string> path = stringSplit(category, ':');
...
std::vector<std::string>	ft::config::getSubcategory(std::string &category)
{
	std::vector<std::string> 	fieldsRet;
	categoryType	location = __category;
	std::vector<std::string> path = stringSplit(category, ':');
...
std::vector<std::string>	ft::config::getSubcategory(categoryObject *object, std::string &category)
{
	std::vector<std::string> 	fieldsRet;
	categoryType	location = object->subcategory;
	std::vector<std::string> path = stringSplit(category, ':');
...
std::string					ft::config::fieldData(std::string &category, std::string &field)
{
	categoryObject *location = getCategoryObject(category);
	return fieldData(location, field);
}

std::string					ft::config::fieldData(categoryObject *objeck, std::string &field)
{
	std::string fieldRet;
